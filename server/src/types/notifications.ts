...
export interface NotificationData {
  ...
  oldGroupName?: string; // Previous group name (for rename notifications)
  newGroupName?: string; // New group name (for rename notifications)
  airportCode?: string;
  actorUserId?: string; // The user who triggered the action
  actorName?: string; // Display name for actor (for richer formatting)
  listingId?: string;
